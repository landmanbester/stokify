...
────────────────────────────────────────────────────────────────────────────────
  ...
  Push your project to GitHub:
    ...
    gh repo create landmanbester/stokify --public --source=. --push

  Or create the repo manually at https://github.com/new and push:

    git remote add origin git@github.com:landmanbester/stokify.git
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/stokify/settings/environments
...
────────────────────────────────────────────────────────────────────────────────
  ...
  a) Create the app:
     ...
     Settings:
       Name:        stokify-bot (or any name you like)
       Homepage:    https://github.com/landmanbester/stokify
  ...
  d) Add secrets to your repository:
     ...
     Go to: https://github.com/landmanbester/stokify/settings/secrets/actions
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/stokify/settings/rules
...
────────────────────────────────────────────────────────────────────────────────
  ...
  The container image is stored in src/stokify/_container_image.py
  ...
  When you create a feature branch:
    ...
    1. Edit src/stokify/_container_image.py and change the tag:

         CONTAINER_IMAGE = "ghcr.io/landmanbester/stokify:my-feature"
